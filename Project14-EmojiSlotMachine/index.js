...
@autobind
export default class EmojiSlotMachine extends React.Component {
  constructor (props) {
    super(props)
  ...
  render () {
    return (
      <Image style={styles.container} source={require('./images/Hyperspace.jpg')} resizeMode='cover'>
        ...
        <View style={styles.buttonContainer}>
          <TouchableHighlight onPress={() => this._go} underlayColor='transparent'>
