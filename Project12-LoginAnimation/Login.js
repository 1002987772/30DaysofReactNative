  ...
  render () {
    return (
      <View style={styles.container}>
        ...
        <Animated.View style={[styles.input, {marginLeft: this.state.marginValue1}]}>
          <View>
            <TextInput
        ...
        <Animated.View style={[styles.input, {marginLeft: this.state.marginValue2}]}>
          <View>
            <TextInput
        ...
        <Animated.View style={[styles.input, {marginLeft: this.state.marginValue2}]}>
          <TouchableHighlight onPress={this._onBttonAniamte} underlayColor='transparent'>
            <Animated.View style={[styles.button, {width: this.state.buttonSize}]}>
